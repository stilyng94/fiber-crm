...
func (c *LeadClient) UpdateOne(l *Lead) *LeadUpdateOne {
	mutation := newLeadMutation(c.config, OpUpdateOne, withLead(l))
...
func (c *LeadClient) DeleteOne(l *Lead) *LeadDeleteOne {
